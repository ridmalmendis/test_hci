  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="button" href="homebase.jsp">
        <button type="button" class="btn btn-primary login100-form-btn">HOME</button>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input" data-validate = "E-maill is required">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="pas" >
						<span class="focus-input100"></span>
					</div>
